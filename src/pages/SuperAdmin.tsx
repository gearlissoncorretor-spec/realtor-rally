...
const PLANS = [
  {
    ...
    screens: ['dashboard', 'vendas', 'negociacoes', 'follow-up', 'metas', 'atividades', 'tarefas-kanban', 'comissoes', 'configuracoes', 'agenda'],
  ...
  },
  {
    ...
    screens: ['dashboard', 'central-gestor', 'vendas', 'corretores', 'equipes', 'ranking', 'negociacoes', 'follow-up', 'metas', 'meta-gestao', 'atividades', 'tarefas-kanban', 'comissoes', 'acompanhamento', 'configuracoes', 'agenda', 'gestao-usuarios'],
  ...
  },
  {
    ...
    screens: ['dashboard', 'central-gestor', 'vendas', 'corretores', 'ranking', 'acompanhamento', 'relatorios', 'configuracoes', 'equipes', 'metas', 'negociacoes', 'follow-up', 'atividades', 'tarefas-kanban', 'meta-gestao', 'x1', 'dashboard-equipes', 'agenda', 'gestao-usuarios', 'comissoes'],
