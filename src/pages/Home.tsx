    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-foreground">CRM Imobiliário</span>
          </div>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-40 right-20 w-48 h-48 bg-success/10 rounded-full blur-3xl animate-bounce-gentle" style={{ animationDelay: '1s' }}></div>
          <div className="absolute bottom-20 left-1/3 w-56 h-56 bg-info/10 rounded-full blur-3xl animate-bounce-gentle" style={{ animationDelay: '2s' }}></div>
        </div>
      ...
      <section className="py-16 px-4 bg-gradient-card">
        <div className="container mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { label: "Vendas Ativas", value: "248", icon: <Target className="w-6 h-6" /> },
              { label: "Corretores", value: "12", icon: <Users className="w-6 h-6" /> },
              { label: "VGV Total", value: "R$ 2.4M", icon: <DollarSign className="w-6 h-6" /> },
              { label: "Taxa Conversão", value: "18.5%", icon: <TrendingUp className="w-6 h-6" /> }
            ].map((stat, index) => (
              <div 
                key={stat.label} 
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <Card 
                key={feature.title} 
                className="p-8 bg-gradient-card border-border hover:shadow-lg transition-all duration-300 group animate-fade-in hover:scale-105"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
      ...
      <section className="py-20 px-4 bg-gradient-hero">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-primary-foreground/90 mb-12 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.1s' }}>
      ...
      <footer className="py-12 px-4 bg-background border-t border-border">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground">
            © 2024 CRM Imobiliário. Transformando vendas com tecnologia.
          </p>
        </div>
      </footer>
    </div>
